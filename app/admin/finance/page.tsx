...
export default async function AdminFinancePage() {
  ...
  return (
    <AdminShell
      ...
      description="Supabase هو مصدر الأرقام. Google Sheets يستقبل تقارير مشتقة فقط."
    >
      <div className="grid gap-5">
              ...
              >
                <div className="flex flex-wrap justify-between gap-2">
                  ...
                  <p className="font-black text-tiger-gold">
                    🧾 المتبقي: {summary.remainingDzd} DZD
                  </p>
                </div>
                <p className="mt-2 text-sm text-white/60">
                  📦 طلبات مكتملة: {summary.completedOrders} · 💰 عمولة:{" "}
                  {summary.commissionDzd} · 💸 مدفوع: {summary.paidDzd} · ➕➖
                  تعديلات: {summary.adjustmentsDzd} · 📅 الدفع القادم:{" "}
                  ...
                  >
                    ...
                    <label className="text-xs text-white/60">
                      ...
                      <input
                        ...
                        type="date"
                        defaultValue={
                          admin.next_payment_date ?? summary.nextPaymentDate
                        }
                        className="mt-1 min-h-11 w-full rounded-xl bg-black px-3"
                      />
                    </label>
        ...
        >
          ...
          <Field label="Spend DZD" name="amountDzd" value="" />
          <label className="grid gap-1 text-sm font-bold text-white/75">
            ملاحظة
            <input
              name="note"
