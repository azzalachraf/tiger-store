...
const copy = {
  ar: {
    title: "ضمان Snapchat", form: "أكمل بيانات الضمان", review: "راجع المعلومات جيداً: بعد التأكيد لا يمكن تعديلها.", name: "الاسم الكامل", user: "اسم المستخدم", platform: "منصة التفعيل", phone: "رقم الهاتف", email: "البريد الإلكتروني", confirm: "تأكيد وإصدار الشهادة", ready: "شهادتك جاهزة", download: "تحميل شهادة PDF", accept: "فهمت التنبيه وأتابع", order: "الطلب", product: "المنتج", plan: "الخطة", expiry: "تاريخ الانتهاء",
    ...
    platformOptions: { placeholder: "اختر المنصة", instagram: "Instagram", snapchat: "Snapchat", facebook: "Facebook" },
  },
  en: {
    ...
    platformOptions: { placeholder: "Choose a platform", instagram: "Instagram", snapchat: "Snapchat", facebook: "Facebook" },
  },
} as const;
