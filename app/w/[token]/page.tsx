...
const copy = {
  ar: {
    title: "ضمان Snapchat", form: "أكمل بيانات الضمان", review: "راجع المعلومات جيداً: بعد التأكيد لا يمكن تعديلها.", name: "الاسم", familyName: "اللقب", user: "اسم المستخدم", phone: "رقم الهاتف", email: "البريد الإلكتروني", paymentMethod: "طريقة الدفع", confirm: "تأكيد وإصدار الشهادة", ready: "شهادتك جاهزة", download: "تحميل شهادة PDF", follow: "تابع Tiger Store على Telegram", accept: "فهمت التنبيه وأتابع", order: "الطلب", product: "المنتج", plan: "الخطة", expiry: "تاريخ الانتهاء",
  ...
  en: {
    title: "Snapchat warranty", form: "Complete warranty details", review: "Review carefully: details cannot be changed after confirmation.", name: "First name", familyName: "Family name", user: "Username", phone: "Phone", email: "Email", paymentMethod: "Payment method", confirm: "Confirm and issue certificate", ready: "Your certificate is ready", download: "Download PDF certificate", follow: "Follow Tiger Store on Telegram", accept: "I understand and continue", order: "Order", product: "Product", plan: "Plan", expiry: "Expiry",
