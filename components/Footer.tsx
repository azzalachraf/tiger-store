      ...
      <div className="mx-auto grid max-w-[1440px] gap-8 px-3 py-10 sm:px-5 md:grid-cols-[1.35fr_1fr_1fr_1fr] lg:px-8">
        <div>
          <div className="mb-4 flex items-center gap-3">
            <Image src="/logo/tiger-head-icon.png" alt="Tiger Store" width={52} height={52} className="h-12 w-12 rounded-2xl object-contain" />
            <div>
          ...
          <p className="max-w-md text-sm leading-7 text-white/62">
            <LocalizedText
              ar="متجر اشتراكات رقمية في الجزائر لخدمات AI، التصميم، التعليم، والبرامج. تفعيل سريع وطرق دفع جزائرية واضحة."
              en="Digital subscription store in Algeria for AI, design, education, and software. Fast activation with clear Algerian payment methods."
            />
          </p>
        ...
        <div>
          <p className="mb-3 font-black text-white"><LocalizedText ar="تواصل" en="Contact" /></p>
          <div className="flex flex-col gap-2 text-sm text-white/62">
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 hover:text-tiger-gold">
              <Image src="/logos/contact/tiger-store.png" alt="" width={18} height={18} className="h-4 w-4 rounded-full object-contain" />
