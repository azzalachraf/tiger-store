  ...
  return (
    <footer className="bg-[#17120F] text-[#F3F0EA]">
      <div className="mx-auto grid max-w-[1440px] gap-8 px-3 py-10 sm:px-5 md:grid-cols-[1.4fr_1fr_1fr] lg:px-8">
        <div>
          <div className="relative h-14 w-40"><Image src="/logo/tiger-store-ui.png" alt="Tiger Store" fill sizes="160px" className="object-contain object-start" /></div>
          <p className="mt-4 max-w-md text-sm leading-7 text-[#F3F0EA]/75">{t(locale, "footerDescription")}</p>
          <p className="mt-3 max-w-lg text-xs leading-6 text-[#F3F0EA]/55">{disclaimer ?? t(locale, "footerDisclaimer")}</p>
        </div>
