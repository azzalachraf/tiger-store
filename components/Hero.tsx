...
export function Hero({ products }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden border-b border-white/10 bg-[#111]">
      <div className="mx-auto grid max-w-[1440px] gap-6 px-3 py-6 sm:px-5 lg:grid-cols-[minmax(0,0.78fr)_minmax(560px,1.22fr)] lg:px-8 lg:py-10" dir={locale === "ar" ? "rtl" : "ltr"}>
