...
- Browser verification covers 80 combinations of mobile/desktop, Arabic/English direction and theme settings. It also checks safe disabling, stock protections, copy history, clipboard failure and finance filtering. Actions use synthetic fixtures, never live customer records.
