...
export const telegramCallbackDataSchema = z.union([
  ...
  z.tuple([z.literal("st"), z.enum(["today", "yesterday", "30d", "all"])]),
  ...
  z.tuple([z.literal("cc"), snapchatCardTypeSchema, z.literal("confirm")]),
  ...
  z.tuple([z.literal("rc"), snapchatPlanSchema, snapchatCardTypeSchema]),
  z.tuple([z.literal("rq"), snapchatPlanSchema, snapchatCardTypeSchema, z.union([z.literal(1), z.literal(2), z.literal(3), z.literal(4), z.literal(5), z.literal(6)])]),
  z.tuple([z.literal("ds"), z.string().uuid(), z.string().regex(/^[1-9][0-9]{0,7}$/), z.enum(["complete", "cancel"])]),
...
export const adminOrderSchema = z.object({
  ...
  paymentMethod: storedPaymentMethodSchema,
