...
const plans = { 1: { price: 600, commission: 100 }, 2: { price: 800, commission: 100 }, 3: { price: 1600, commission: 100 }, 6: { price: 2000, commission: 100 }, 12: { price: 2300, commission: 100 } };
...
assert.equal(plans[12].price - plans[12].commission - Math.floor(costs.inr_298 * 250 / 100), 1363);
